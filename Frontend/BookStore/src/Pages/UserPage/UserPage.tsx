...
const UserPage: Component = () => {
  ...
  return (
    <div class="grid grid-cols-12">
      ...
      <section class="col-span-12 lg:col-span-4 flex-col mb-3 mx-2">
      ...
      <section class="col-span-12 lg:col-start-3 lg:col-span-4 flex-col mb-3 mx-2">
        <div class="text-everforest-fg flex justify-around items-center mb-2">
          <Heart />
      ...
      <div class="lg:col-start-3 col-span-12 mt-2 lg:col-span-8 flex justify-center">
        <button
          onclick={auth.logout}
