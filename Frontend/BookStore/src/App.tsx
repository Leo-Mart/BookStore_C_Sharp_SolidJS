        ...
        <CartProvider>
          <Router root={Layout}>
            ...
            <Route path="/user-profile">
              ...
              <Route path="/user-wishlists" component={VerifyAuth(UserPageWishlists)} />
              <Route path="/user-orders" component={VerifyAuth(UserPageOrders)} />
              <Route path="/user-reviews" component={VerifyAuth(UserPageReviews)} />
              <Route path="/user-info" component={VerifyAuth(UserPageUserInfo)} />            
            </Route>
