...
namespace BookStore.DbContexts
{
        ...
        : IdentityDbContext<AppUser>(dbContextOptions)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder
                ...
                .HasData(
                    ...
                    new Book()
                    {
                        ...
                        Description =
                            "The final, apocalyptic chapter in one of the most original, exciting and acclaimed fantasy series of our time . Their desire is to cleanse the world - to eradicate every civilization, to annihilate every human - in order to begin anew. And outside the abandoned city of Kharkanas, thousands have gathered upon the First Shore.",
                        Price = 239,
                        UpdatedAt = new DateTime(2026, 6, 5),
                        CreatedAt = new DateTime(2026, 6, 5),
                    }
            ...
            modelBuilder
                ...
                .HasData(
                    new AppUser
                    {
                        ...
                        AccessFailedCount = 0,
                        PasswordHash =
                            "AQAAAAIAAYagAAAAEDo5bk0UyyMvrhmqvw+gCLnDkvWWjE2xbXj6qX93YoEOYLR9pY5LGwBNm0qDScF23g==",
                    },
                    new AppUser
                    {
            ...
            modelBuilder
                ...
                .HasData(
                    ...
                    new Genre()
                    {
                        ...
                        Description =
                            "Speculative fiction exploring futuristic science, technology, space exploration, and their impact on society.",
                    ...
                    new Genre()
                    {
                        ...
                        Name = "Classic",
                        Description =
                            "Foundational works of literary fiction widely considered to be of superior quality and enduring significance.",
                        CreatedAt = new(2026, 1, 1),
                        UpdatedAt = new(2026, 1, 1),
                    }
                );
            ...
            var rawBookAuthors = System.Text.Json.JsonSerializer.Deserialize<List<JsonElement>>(
                File.ReadAllText(@"./SeedData/book_authors.json")
            );
            var bookAuthorSeedData = rawBookAuthors
                .Select(e => new
                {
            ...
            var rawBooksGenres = System.Text.Json.JsonSerializer.Deserialize<List<JsonElement>>(
                File.ReadAllText(@"./SeedData/book_genres.json")
            );
            var bookGenresSeedData = rawBooksGenres
                .Select(e => new
                {
                    BooksId = e.GetProperty("booksId").GetInt32(),
